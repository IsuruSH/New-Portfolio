      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Creating elegant digital experiences with a focus on user-centered design and 
              clean, maintainable code. Let's build something beautiful together.
            </motion.p>
            <motion.div 
          ...
          >
            ...
            <ul className="space-y-2">
              <li>
                <a href="#hero" className="text-secondary-600 hover:text-primary-600 transition-colors">
                  Home
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#skills" className="text-secondary-600 hover:text-primary-600 transition-colors">
                  Skills
                </a>
              </li>
              <li>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:shanakaisuru11@gmail.com" className="text-secondary-600 hover:text-primary-600 transition-colors">
                  shanakaisuru11@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+94768324613" className="text-secondary-600 hover:text-primary-600 transition-colors">
                  +94 768 324 613
                </a>
              </li>
            </ul>
        ...
        >
          ...
          <p className="text-secondary-600 text-sm flex items-center">
            Made with <Heart size={14} className="mx-1 text-accent-500" /> using React & Tailwind
          </p>
        </motion.div>
      </div>
    </footer>
